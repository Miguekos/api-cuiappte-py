...
def enviarCorreo(correofrom, nombre, clave):
    import smtplib
    ...
    *[x-apple-data-detectors],  /* iOS */
              	...
              	<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              		<tr>
              			<td class="logo" style="text-align: center;">
    			            <h1><a style="color: #000000;" href="#"><b style="color: green;">C</b>uid<b style="color: red;">APP</b>te</a></h1>
    			          </td>
              		</tr>
              	</table>
              </td>
    ...
    msg['Subject'] = 'Hola {}: Tu password'.format(nombre)

    msg['From'] = 'info@pandorati.com'
    msg['To'] = correofrom
    password = "T!24052020"
    ...
    # password = "T!24052020"
    # msg['From'] = "info@pandorati.com"
    # msg['To'] = "miguekos1233@gmail.com"
    # msg['Subject'] = "Subscription"

    s = smtplib.SMTP('smtpout.secureserver.net:587')
    s.starttls()
...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f1f1f1;">
    ...
    msg = email.message.Message()
    msg['Subject'] = 'Hola Ingrid Tejada: Tu password'
